...
export const AddGlucoseModal = ({isOpen, handleToggleModal}) => {
  ...
  return (
    <div className={`${isOpen ? "block" : "hidden"} w-[min(90vw,400px)] h-80 bg-white border rounded-md absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2`}>
